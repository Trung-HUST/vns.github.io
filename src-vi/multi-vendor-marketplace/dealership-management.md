...
Hệ thống Quản lý đại lý cho phép người bán trên thị trường thêm các sản phẩm đã có trong danh mục cửa hàng do quản trị viên tạo. 

Thay vì xây dựng mọi sản phẩm từ đầu, các đại lý có thể chỉ cần chọn các mặt hàng từ danh mục chính và xuất bản chúng với giá, kho hàng và thông tin chi tiết của riêng họ.

Điều này giúp việc niêm yết nhanh hơn, giữ thông tin sản phẩm nhất quán và giảm nỗ lực cần thiết để bắt đầu bán hàng.
...
Nhập tất cả các chi tiết cần thiết cho phiên bản cá nhân hóa của sản phẩm hiện có.

**1) Tình trạng:** Ghi rõ tình trạng của sản phẩm (Mới, Cũ).

**2) Giá:** Nhập giá bán bạn muốn đưa ra cho sản phẩm này.

**3) Số lượng:** Thêm số lượng sản phẩm có sẵn trong kho.

**4) Mô tả:** Cung cấp mô tả ngắn gọn về sản phẩm.

**5) Hình ảnh:** Tải hình ảnh sản phẩm lên để giới thiệu sản phẩm.
...
1) Chọn hộp kiểm sản phẩm cho mặt hàng muốn phê duyệt.

2) Đi tới menu thả xuống Chọn hành động.
