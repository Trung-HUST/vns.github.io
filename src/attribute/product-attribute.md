...
### How to Create a Product Attribute in VNS

To create VNS Attributes, open the Admin Panel and then follow the steps below.
...
- **Attribute Type**: VNS provides various attribute types such as Text, Textarea, Price, Boolean, Select, Multi-select, and DateTime.
...
By following the above steps, you can easily create a Product Attribute in VNS.
